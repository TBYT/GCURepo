...
//	MyTimerService timer;
	...
	{
		//hardcoded product here to show that the product is added when clicking send order..
		service.sendOrder(new Order(101, "0101","This is product from send order.",(float)1.00,1));
